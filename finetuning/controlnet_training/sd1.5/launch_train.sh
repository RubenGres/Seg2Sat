...
--output_dir=modelout \
--dataset_name=rgres/AerialDreams \
--conditioning_image_column=segmentation \
--image_column=image \
--caption_column=prompt \
--resolution=512 \
--learning_rate=1e-06 \
--validation_image "/workspace/Drawing2Map/controlnet_training/validation/mask/MSK_066278.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/MSK_067998.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/MSK_073879.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/MSK_074756.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/MSK_076201.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/zMSK_076201_style1.png" "/workspace/Drawing2Map/controlnet_training/validation/mask/zMSK_076201_style2.png" \
...
--train_batch_size=5 \
--num_train_epochs=3 \
--tracker_project_name=aerialdreams \
